...
if Rails.env.development?
  pin 'react', to: 'https://ga.jspm.io/npm:react@18.1.0/dev.index.js'
  pin 'react-dom', to: 'https://ga.jspm.io/npm:react-dom@18.1.0/dev.index.js'
  pin 'react-dom/client', to: 'https://ga.jspm.io/npm:react-dom@18.1.0/dev.client.js'
  pin 'object-assign', to: 'https://ga.jspm.io/npm:object-assign@4.1.1/index.js'
  pin 'scheduler', to: 'https://ga.jspm.io/npm:scheduler@0.22.0/dev.index.js'
  pin 'scheduler/tracing', to: 'https://ga.jspm.io/npm:scheduler@0.22.0/dev.tracing.js'
  pin 'prop-types', to: 'https://ga.jspm.io/npm:prop-types@15.8.1/dev.index.js'
else
